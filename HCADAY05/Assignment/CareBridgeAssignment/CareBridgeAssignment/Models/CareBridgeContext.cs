...
namespace CareBridgeAssignment.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Claim__EF2E139B170DDD52");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED91AD48FC");
        ...
        {
            entity.HasKey(e => e.DiagnosisId).HasName("PK__Diagnosi__0C54CC73810ABC27");
        ...
        {
            entity.HasKey(e => e.EncounterId).HasName("PK__Encounte__4278DD36C46D69CE");
        ...
        {
            entity.HasKey(e => e.InsuranceId).HasName("PK__Insuranc__74231A2438F70A22");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patient__970EC3668F7699B0");
            ...
            entity.HasIndex(e => e.Mrn, "UQ__Patient__C790FDB4A309FC47").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProcedureId).HasName("PK__Procedur__54C2E52D9F5462D8");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687DCF0F9038");
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.Providers)
                .HasForeignKey(d => d.DepartmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Provider__Depart__3A81B327");
        });
